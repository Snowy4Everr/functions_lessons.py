...
def number_attributes(**kwargs):
    return len(kwargs) #Return the number of keyword arguments passed
print(number_attributes(height=6.1, weight=195, age=30))
...
print(list_attributes(eye_color="blue", hair_color="blonde", height=5.9))
